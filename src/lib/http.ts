      ...
      if (isClient) {
        if (!clientLogoutRequest) {
          ...
          try {
            ...
            // Và nếu rơi vào trường hợp tại trang login, chúng ta có gọi các API cần access token
            // Mà access token bị xoá thì nó lại nhảy vào đây, và cứ thế nó bị lặp
            location.href = '/login'
          }
        }
      } else {
        // Đây là trường hợp khi mà chúng ta vẫn còn hạn access token
